...
public class CashRepaymentController {
    ...
    public ResponseEntity<PaymentInfoResponse> getPaymentInfo(@RequestHeader("X-USER-ID") String userId) {

        PaymentInfoResponse paymentInfo = repaymentService.getPaymentInfo(Long.parseLong(userId));
